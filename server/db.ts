...
import { InsertUser, users, recommendations, InsertRecommendation } from "../drizzle/schema";
...
/**
 * Get all recommendations for a specific user, ordered by most recent first
 */
